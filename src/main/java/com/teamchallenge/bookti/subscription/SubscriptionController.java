...
public class SubscriptionController {
    ...
    public ResponseEntity<Boolean> checkIfUserIsSubscribed(@AuthenticationPrincipal AuthorizedUser authorizedUser,
        ...
        log.info(
                "SubscriptionController::checkIfUserIsSubscribed - Get /subscriptions/status - return Boolean info about subscription.");
    ...
    public ResponseEntity<AppResponse> deleteById(@PathVariable("subscriptionId") Integer subscriptionId) {
        ...
        log.info(
                "SubscriptionController::deleteById - Delete /subscriptions/{subscriptionId} - return successfully deleted subscription message.");
        return ResponseEntity.ok(response);
    }
}
