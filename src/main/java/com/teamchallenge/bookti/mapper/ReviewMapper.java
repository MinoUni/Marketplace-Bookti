...
public interface ReviewMapper {
    ...
    @Mapping(target = "rating", expression = "java(userReview.getRating().setScale(1, java.math.RoundingMode.HALF_UP))")
    ...
    UserReviewResponseDTO toUserReviewResponseDTO(List<UserReview> userReviewList, UserProfileDTO userProfileDTO);
}
